# Supabase Next.js File Management

This example will set you up for a very common situation: users can upload / download any type of files and use supabase file cloud storage.
